...
namespace de4dot.code.deobfuscators.CodeVeil {
	class ResourceConverter {
		...
		ResourceElement Convert(ResourceInfo info) {
			...
			case 31:	// binary
				resourceData = dataCreator.CreateSerialized(reader.ReadBytes(info.length), SerializationFormat.BinaryFormatter, dataCreator.CreateUserResourceType("System.Object,mscorlib"));
				break;
